...
class App():
    def __init__(self):
        pyxel.init(180,128,title="MazeWalkMan",fps=24)
...
#                      pyxel.GAMEPAD1_AXIS_LEFTX
#        ]
#        self.LAXIS_RANGE = [[-36000,-3000],[3000,36000],[3000,36000],[-36000,-3000]]
    ...
    def draw(self):
        ...
        # 敵キャラ紹介
        pyxel.text(138, 54,"  OIKAKE",13)
        pyxel.blt(162,60,0,0,48,8,8,0)
        pyxel.text(138, 72,"MATIBUSE",13)
        pyxel.blt(162,78,0,0,56,8,8,0)
        pyxel.text(138, 90,"KIMAGURE",13)
        pyxel.blt(162,96,0,0,64,8,8,0)
        pyxel.text(138,108," OTOBOKE",13)
        pyxel.blt(162,114,0,0,72,8,8,0)
        ### 敵キャラを描画
